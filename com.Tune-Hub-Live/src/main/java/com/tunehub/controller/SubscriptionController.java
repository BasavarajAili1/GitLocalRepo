...
public class SubscriptionController {
    ...
    public String createOrder() {
        Order order = null;
        try {													// My razorpay ID
            RazorpayClient razorpay = new RazorpayClient("rzp_test_pHqmevcno13sq3", "HmokA5aSASN4LO4ulMP1wm26");
    ...
    public boolean verifyPayment(@RequestParam String orderId, @RequestParam String paymentId,
        ...
        try {
            ...
            RazorpayClient razorpayClient = new RazorpayClient("rzp_test_pHqmevcno13sq3", "HmokA5aSASN4LO4ulMP1wm26");
	        
	        // Create a signature verification data string
            String verificationData = orderId + "|" + paymentId;
            
            // Use Razorpay's utility function to verify the signature
            boolean isValidSignature = Utils.verifySignature(verificationData, signature, "HmokA5aSASN4LO4ulMP1wm26");
